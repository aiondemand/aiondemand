...
class AiodPkg__Sklearn(_ModelPkgSklearnEstimator):
    ...
    _obj_dict = {'ARDRegression': 'sklearn.linear_model.ARDRegression',
    ...
    _type_of_objs = {'ARDRegression': 'regressor',
     ...
     'FastICA': 'transformer',
     'FeatureAgglomeration': 'clusterer',
     ...
     'GaussianMixture': 'DensityEstimator',
     ...
     'PCA': 'transformer',
     'PLSCanonical': 'regressor',
     'PLSRegression': 'regressor',
     'PLSSVD': 'transformer',
    ...
    _objs_by_type = {'DensityEstimator': ['BayesianGaussianMixture', 'GaussianMixture'],
