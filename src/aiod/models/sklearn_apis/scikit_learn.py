...
class AiodPkg__Sklearn(_ModelPkgSklearnEstimator):
    ...
    _type_of_objs = {
        ...
        "Pipeline": ["classifier", "regressor", "transformer", "cluster", "density", "outlier_detector"],
        "GridSearchCV": ["classifier", "regressor", "transformer", "cluster", "density", "outlier_detector"],
        "RandomizedSearchCV": ["classifier", "regressor", "transformer", "cluster", "density", "outlier_detector"],
    }
    ...
    _objs_by_type = {
        ...
        "density": ["BayesianGaussianMixture", "GaussianMixture", "Pipeline", "GridSearchCV", "RandomizedSearchCV"],
        "outlier_detector": [
            "EllipticEnvelope",
            "IsolationForest",
            "LocalOutlierFactor",
