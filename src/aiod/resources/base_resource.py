...
class BaseResource:
    ...
    def register(self, metadata, *, version=None):
        return calls.post_asset(
            asset_type=self.asset_type, metadata=metadata, version=version
        )

    def replace(self, identifier, metadata, *, version=None):
        return calls.put_asset(
            asset_type=self.asset_type,
    ...
    def get_list_async(
        self, *, offset=0, limit=100, batch_size=10, version=None, data_format="pandas"
    ):
        return calls.get_list_async(
            asset_type=self.asset_type,
            offset=offset,
            limit=limit,
