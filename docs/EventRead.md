...
**start_date** | **object** | The start date and time of the event, formatted using the ISO 8601 date-time format. | [optional] 
**end_date** | **object** | The end date and time of the event, formatted using the ISO 8601 date-time format. | [optional] 
**schedule** | **object** | The agenda of the event. | [optional] 
**registration_link** | **object** | The url of the registration form. | [optional] 
...
**mode** | **object** | The attendance mode of event. | [optional] 
**note** | **object** | Notes on this AI resource. | [optional] 
**organiser** | **object** | The person or organisation responsible for organising the event. | [optional] 
**performer** | **object** | Links to identifiers of the agents (person or organization) that is contributing to this event  | [optional] 
...
**status** | **object** | The status of the event. | [optional] 
**identifier** | **object** |  | 
